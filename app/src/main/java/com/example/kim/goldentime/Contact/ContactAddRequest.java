...
public class ContactAddRequest extends StringRequest {
    ...
    final static private String URL ="http://ehdtjs3694.cafe24.com/AddContact.php";
    private Map<String, String> parameters;

    //생성자 부분 구축
    public  ContactAddRequest(String userID, String userName, String userTel, Response.Listener<String> listener) {
