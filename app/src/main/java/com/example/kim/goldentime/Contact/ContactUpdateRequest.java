...
public class ContactUpdateRequest extends StringRequest {
    ...
    final static private String URL ="http://ehdtjs3694.cafe24.com/UpdateContact.php";
    private Map<String, String> parameters;

    //생성자 부분 구축
    public ContactUpdateRequest(String userID, String userNameinfo, String userTelinfo, String userName, String userTel, Response.Listener<String> listener) {
        ...
        parameters.put("userNameinfo", userNameinfo);
        parameters.put("userTelinfo", userTelinfo);
